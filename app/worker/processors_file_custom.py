...
class EmbeddingCustomProcessor(EmbeddingFileProcessor):
    """Processor for custom text embedding jobs."""
    ...
    async def start_embedding(self, job_data: Dict[str, Any], job_id: str, trace_id: str, owner: str = None) -> Dict[str, Any]:
        ...
        extra_data = {
            "extra_data": {k: v for k, v in job_data.items() if k != "content_base64"}
        }
        ...
        binary = job_data.get("content_base64", None)
